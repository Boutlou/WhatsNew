...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        navigationBarAppearace.barTintColor = UIColor(red:0.00, green:0.00, blue:0.00, alpha:1.0)
      //bar status
        navigationBarAppearace.barStyle = .blackOpaque
        //navigationBarAppearace.layer.borderWidth = 0
       // navigationBarAppearace.backgroundColor = UIColor(red:0.00, green:0.00, blue:0.00, alpha:1.0)
        return true
    }
